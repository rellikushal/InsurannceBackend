...
@Entity
@Table
public class NotificationHystoryForEmail 
{
...
//	}
	...
	public NotificationHystoryForEmail(long id, String customerId, String email, String status,LocalDateTime date) {
		super();
		this.id = id;
		this.customerId = customerId;
		this.email = email;
	...
	public NotificationHystoryForEmail() {
		super();
